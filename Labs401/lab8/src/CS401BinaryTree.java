/**
 * Created by shubhankar on 10/18/16.
 */
/*
...
public class CS401BinaryTree<E>  {
    ...
    private int index;        /* This is the index of the right node to insert
                                in the tree. */
    ...
    /* -------------------------------------------------------------------
     * Iteratively does an inorder traversal of the tree
     */
    public void inorder_iterative() { inorder_pi(root); }

    /*
     * Complete the following method to do an inorder traversal. */
    private void inorder_pi(TreeNode<E> current)  {
      /*
       * ADD YOUR CODE HERE
       * ADD YOUR CODE HERE
       *
       */
        CS401StackLinkedListImpl<TreeNode<E>> cs401StackLinkedList = new CS401StackLinkedListImpl<>();
        for (int i=0; i<index; i++) {
            if (current.left != null) {
                cs401StackLinkedList.push(current);
                current = current.left;
            }
            else {
                System.out.print(current.info + " ");
                if (!cs401StackLinkedList.is_empty()) {
                    current = cs401StackLinkedList.pop();
                    System.out.print(current.info + " ");
                }
    ...
    public static void main(String[] args)  {
       ...
       */
        ...
        bt.postorder();
        System.out.println();
        System.out.println("Iterative inorder is: ");
