...
public class CS401BST<E extends Comparable<E>> {
     ...
     *
     * @return the height of this BinarySearchTree object
     */
    public int leaves() {
        return leaves(root) / 2;
    }
     ...
     */
    public int leaves(TreeNode<E> e) {
        if (e == null) {
            return 1;
        } else return leaves(e.left) + leaves(e.right);
    }
     ...
     * @return the height of this BinarySearchTree object
     */
    private int h(TreeNode<E> p) {
        if (p == null) {
            return -1;
        } else return 1 + Math.max(h(p.left), h(p.right));
    }
    ...
    public E search(E e) {
        ...
        TreeNode<E> x = root;
        while (x != null) {
            comp = (e).compareTo(x.element);
            if (comp == 0) return x.element;
    ...
    protected TreeNode<E> deleteTreeNode(TreeNode<E> p) {
        ...
        if (p.left != null) replacement = p.left;
    ...
    protected TreeNode<E> successor(TreeNode<E> e) {
        if (e == null) return null;
            ...
            // successor is left
            // most TreeNode in right subtree of e
    ...
    protected static class TreeNode<E> {
        ...
        protected TreeNode<E> left = null, right = null, parent;
